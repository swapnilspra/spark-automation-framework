...
class Job(ETLJob):
    ...
    joins:List[Dict[str,Any]] = [
        ...
        },
        {
            "source": "parent",
            "conditions": [
                F.lit("SHENKMAN") == F.upper(F.col("parent.sctr_type")),
    ...
    target_mappings:List[Dict[str,Any]] = [
        ...
        {"source": F.col("infile.`Pct Issuer`"), "target": "fund_wgt_inclv_cash"},
        {"source": F.lit(None).cast("int"), "target": "prim_bmk_wgt"},
        {"source": F.lit(None).cast("int"), "target": "scnday_bmk_wgt"},
