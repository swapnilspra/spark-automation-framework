...
class Job(ETLJob):
    ...
    target_mappings:List[Dict[str,Any]] = [
        ...
        {"source": F.col("infile.`Fund Value Including Cash`"), "target": "fund_yca_mtry_inclv_cash"},
        {"source": F.col("infile.`Fund Value Excluding Cash`"), "target": "fund_yca_mtry_exclsv_cash"},
        {"source": F.col("infile.`Benchmark 1 Value Excluding Cash`"), "target": "prim_bmk_mtry"},
