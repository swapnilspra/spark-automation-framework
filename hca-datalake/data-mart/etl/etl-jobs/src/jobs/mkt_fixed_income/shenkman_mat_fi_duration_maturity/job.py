...
class Job(ETLJob):
    ...
    target_mappings:List[Dict[str,Any]] = [
        ...
        {"source": F.col("infile.`Fund Value Incl Cash`"), "target": "fund_yca_mtry_inclv_cash"},
        {"source": F.col("infile.`Fund Value Excl Cash`"), "target": "fund_yca_mtry_exclsv_cash"},
        {"source": F.col("infile.`Benchmark 1`"), "target": "prim_bmk_mtry"},
        {"source": F.col("infile.`Benchmark 2`"), "target": "secy_bmk_mtry"},
