...
ALTER TABLE hdm.fin_country
	ADD CONSTRAINT fin_country_ix_AK1 UNIQUE (fin_region_key,country_name);

CREATE INDEX fin_country_ix_IF1 ON hdm.fin_country
( 
	fin_region_key ASC
);
...
ALTER TABLE hdm.fin_country
	ADD CONSTRAINT fin_country_ix_IF1 FOREIGN KEY (fin_region_key) REFERENCES hdm.fin_region(fin_region_key)
		ON UPDATE SET NULL
		ON DELETE SET NULL;
...
COMMENT ON COLUMN hdm.fin_country.fin_region_key IS 'FIN Region Key';
